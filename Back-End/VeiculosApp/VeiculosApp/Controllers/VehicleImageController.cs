...
namespace VeiculosApp.Controllers
{
    ...
    //    [HttpPut()]
    //    public IActionResult Update([FromBody] UpdateVehicleImageViewModel updateVehicleViewModel)
    //    {
    ...
    //    [HttpPost()]
    //    public IActionResult Save([FromBody] SaveVehicleImageViewModel saveVehicleViewModel)
    //    {
    //        var vehicle = _mapper.Map<IList<AnnoucementImage>>(saveVehicleViewModel.VehicleImage);            
    ...
    //    {
    //        var query = new GetAllVehicleImage();
